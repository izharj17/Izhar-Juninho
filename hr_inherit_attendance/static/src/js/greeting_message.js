odoo.define('hr_inherit_attendance.greeting_message', function (require) {
"use strict";
...
var GreetingMessage = AbstractAction.extend({
    ...
    init: function(parent, action) {
        ...
        // Adjust the check-in time by adding 7 hours
        this.attendance.check_in_time = this.attendance.check_in && moment(this.attendance.check_in).add(7, 'hours').format(this.format_time);

        // Adjust the check-out time by adding 7 hours
        this.attendance.check_out_time = this.attendance.check_out && moment(this.attendance.check_out).add(7, 'hours').format(this.format_time);
