...
class WebsitePPDBSM(http.Controller):
    ...
    # @http.route('/api/admission_sm', type='json', auth='public', methods=['POST'], csrf=False)
    # def create_admission_sm(self, **kwargs):
    #     try:
    ...
    #         nama_panggilan = kwargs.get('nama_panggilan')
    ...
    #         # Additional fields for 'Lingkungan rumah' section
    ...
    #         catatan_khusus = kwargs.get('catatan_khusus')
    ...
    #         admission = request.env['formulir.sm'].sudo().create({
    ...
    #                 'name': 'Signature Ayah',
    #                 'type': 'binary',
    #                 'datas': ttd_ayah,  # Expecting base64 encoded string
    #                 'res_model': 'formulir.sm',
    #                 'res_id': admission.id,
    #                 'mimetype': 'image/png',  # Adjust based on file type
    #             })
    ...
    #                 'name': 'Signature Ibu',
    #                 'type': 'binary',
    #                 'datas': ttd_ibu,  # Expecting base64 encoded string
    #                 'res_model': 'formulir.sm',
    #                 'res_id': admission.id,
    #                 'mimetype': 'image/png',  # Adjust based on file type
    #             })
    ...
    @http.route('/api/admission_sm', type='http', auth='public', methods=['POST'], csrf=False, website=True)
    def create_admission_sm(self, **post):
        try:
            print("API /api/admission_sm accessed")
            ...
            birth_date = post.get('birth_date')or None
            ...
            tgl_lahir_ayah = post.get('tgl_lahir_ayah')or None
            ...
            tgl_lahir_ibu = post.get('tgl_lahir_ibu')or None
